...
# RTSP input setup
rtsp_url = "rtsp://admin:@Deee123@10.40.16.216:554/Streaming/Channels/101"
gstreamer_pipeline = (
    f"rtspsrc location={rtsp_url} latency=200 ! "
    "rtph264depay ! h264parse ! nvv4l2decoder ! "
    "nvvidconv ! video/x-raw,format=BGR ! xvimagesink"
)
...
output_dir = 'detected_faces/special'
...
def process_stream(rtsp_url, gstreamer_pipeline, output_dir, video_out_path, stream_name):
    ...
    while True:
        ...
        cv2.putText(display_frame, f"{stream_name} Count: {current_count}", (20, 40),
                    cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 255), 2)
        out.write(display_frame)
        cv2.imshow(f'Live Face Detection - {stream_name}', display_frame)
        if frame_count % 10 == 0:
            logger.info(f"{face_counter} faces")
...
if __name__ == "__main__":
    rtsp_configs = {
        ...
        'exit': {
            'url': 'rtsp://admin:FYPgroup33@10.40.16.214:554/Streaming/Channels/101',
            'gstreamer': 'rtspsrc location=rtsp://admin:FYPgroup33@10.40.16.214:554/Streaming/Channels/101 latency=200 ! rtph264depay ! h264parse ! nvv4l2decoder ! nvvidconv ! video/x-raw,format=BGR ! xvimagesink',
